...
const meal_type = new URLSearchParams(window.location.search).get("mealType");

fetch(`https://dummyjson.com/recipes/meal-type/${meal_type}`)
  .then((res) => res.json())
...
const url = `https://dummyjson.com/recipes/meal-type/${meal_type}`; // limit=0 henter alle 50 opskrifter
